...
from classes.TSPCustomInitEmbedding import TSPCustomInitEmbedding
from classes.TSPGraphPlotCallback import TSPGraphPlotCallback
from classes.TSPMatricPlotCallback import TSPPlotMetricCallback
from classes.TSPValBaselineCallback import TSPValBaselineCallback
import time
...
policy = AttentionModelPolicy(
    ...
    num_encoder_layers=6,
    embed_dim=embed_dim,
    init_embedding= TSPCustomInitEmbedding(embed_dim, k_neighbors=5),  
)
...
plot_graphs_cb = TSPGraphPlotCallback(
    env,
    num_examples=5,
    subdir="val_plots",
    decode_type="greedy",
